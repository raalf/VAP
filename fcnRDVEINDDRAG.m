function [inddrag]=fcnRDVEINDDRAG(matCOEFF,matDVE,matVLST,matUINFTE,vecDVEHVSPN,vecDVETE,...
...
%
% Induced dve drag. Function finds induced drag values on each te element.
% Outputs are not non-dimensionalized to q.
...
% on (1:numte), etc. 
% Move all points, then overwrite the cases when
