...
if flagSTATIC == 1
    ...
    [matTWISTGLOB(valTIMESTEP,:)] = fcnSTATICTWIST(vecLIFTDIST, vecDVEHVSPN, matGJt, vecEDGEPITCH, vecCLDIST, matTWISTGLOB,...
...
[matNPVLST, matNPNEWWAKE, matNEWWAKE, valUINF, vecEDGEPITCH] = fcnMOVEFLEXWING_STATIC(valALPHA, valBETA, valDELTIME, matVLST, matCENTER, matDVE, vecDVETE, vecDVEHVSPN, vecDVELE, matNPVLST, matDEFGLOB,...
