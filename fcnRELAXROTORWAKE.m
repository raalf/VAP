function [vecWDVEHVSPN, vecWDVEHVCRD, vecWDVEROLL, vecWDVEPITCH, vecWDVEYAW,...
    ...
    vecWDVEROLL, vecWDVESYM, vecWDVETESWP, vecWDVETIP, vecWDVEYAW, vecWK, vecWDVEWING, flagSTEADY, valAZNUM, flagHOVERWAKE, vecN, vecM, vecDVELE, vecDVEPANEL, maxRot)
...
startVel = 6;
if valTIMESTEP/valAZNUM <= maxRot && flagHOVERWAKE == 1
