...
[valNELE, matNPVLST0, vecAIRFOIL, vecDVELE, vecDVETE, vecDVEYAW, ...
    ...
    vecDVELESWP, vecDVEHVCRD, vecDVEHVSPN0, vecSYM, matADJE, matCENTER0,...
...
for ai = 1:length(seqALPHAR)
    ...
    [matUINF, matUINFTE, matTEPTS, vecTHETA, vecCPRADI] = ...
    ...
    for valTIMESTEP = 1:valMAXTIME
       ...
       % Generate new wake elements
        ...
        [valCT, valCQ, valCP, vecCTCONV, vecCQCONV, vecCPCONV, ...
            vecDISTHRUST, vecDISTORQUE, vecDISNORM] =  ...
            fcnRFORCES(valAZNUM, valDIA, valRPM, valWSIZE, valTIMESTEP, ...
            valNELE, valWNELE, seqALPHAR, vecCPRADI,vecDVEPITCH, ...
        ...
        if valTIMESTEP > valMAXTIME - valAZNUM % Only run for last rotation
            ...
            [vecCTCONV(temp), vecCQCONV(temp), vecCPCONV(temp)] = ...
                ...
                valDIA, valKINV, vecCPRADI, vecDVEHVCRD, vecN, vecM, ...
