...
[flagRELAX, flagSTEADY, valMAXTIME, valMINTIME, valAZNUM, valDELTAE, ...
    seqALPHAR, valJ, valDENSITY, valKINV, valAREA, valDIA, vecROTAX, ...
    valPANELS, matGEOM, vecAIRFOIL, vecN, vecM, vecSYM, valINTERF] = ...
    fcnVAPTORREAD(strFILE);
