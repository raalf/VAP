function [matNPVLST, matNPNEWWAKE, matNEWWAKE, valUINF, vecEDGEPITCH] = fcnMOVEFLEXWING_STATIC(valALPHA, valBETA, valDELTIME, matVLST, matCENTER, matDVE, vecDVETE, vecDVEHVSPN, vecDVELE, matNPVLST, matDEFGLOB,...
